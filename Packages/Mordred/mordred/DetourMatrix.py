...
class CalcDetour(object):
    ...
    def __call__(self):
        ...
        for bcc in (self.G.subgraph(c).copy() for c in networkx.biconnected_components(self.G)): #FIXED deprecated: networkx.biconnected_component_subgraphs(self.G, False):
